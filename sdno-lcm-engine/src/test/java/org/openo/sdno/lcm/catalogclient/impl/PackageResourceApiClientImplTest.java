...
public class PackageResourceApiClientImplTest {
    ...
    PackageResourceApiClientImpl packageResourceApiClientImpl;

    Environment mockEnvironment;

    @BeforeMethod
    public void before() {
        packageResourceApiClientImpl = new PackageResourceApiClientImpl();
        mockEnvironment = mock(Environment.class);
        packageResourceApiClientImpl.setEnv(mockEnvironment);
    ...
    public void queryPackageById() {
        packageResourceApiClientImpl.queryPackageById(FAKE_TEMPLATE_ID);
    }
     ...
     */
    @Test(expectedExceptions = ExternalComponentException.class)
    public void queryPackageListByCond() {
        packageResourceApiClientImpl.queryPackageListByCond(FAKE_TEMPLATE_ID, null, null, null, null);
    }
}
